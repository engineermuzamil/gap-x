            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl w-full">
              ...
              <Link href="/notes" className="block">
                <div className="bg-[#2C2C2E] p-6 rounded-xl hover:bg-[#3C3C3E] transition-colors duration-200">
                  ...
                  <p className="text-gray-400">Organize your notes and thoughts in one place</p>
                </div>
              </Link>
              ...
              <Link href="/projects" className="block">
                <div className="bg-[#2C2C2E] p-6 rounded-xl hover:bg-[#3C3C3E] transition-colors duration-200">
                  ...
                  <p className="text-gray-400">Manage your projects hassle free</p>
                </div>
              </Link>
            </div>
          </div>
